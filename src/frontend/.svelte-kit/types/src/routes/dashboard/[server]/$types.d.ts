...
type RouteParams = { server: string };
type RouteId = '/dashboard/[server]';
...
type LayoutRouteId = RouteId | "/dashboard/[server]" | "/dashboard/[server]/apache" | "/dashboard/[server]/docker" | "/dashboard/[server]/firewall" | "/dashboard/[server]/systemd"
type LayoutParams = RouteParams & { server?: string | undefined }
